...
public class HomeFragment extends Fragment implements View.OnClickListener {
    ...
    private void searchRecipe(String search) {
        ...
        String URL="https://api.spoonacular.com/recipes/search?query=" + search + "&number=30&instructionsRequired=true&apiKey=61a8215e0d0d4b5db0750a17e1e1c2ce";
    ...
    private void getRandomRecipes() {
        String URL = " https://api.spoonacular.com/recipes/random?number=30&instructionsRequired=true&apiKey=61a8215e0d0d4b5db0750a17e1e1c2ce";
        RequestQueue requestQueue = Volley.newRequestQueue(getActivity());
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(
                Request.Method.GET,
                URL,
